...
- [ ] **1.1 (WOW MOMENT) Letter-by-letter live scoring with verdict flip**
...
- [ ] **1.2 Per-letter vowel/consonant/cluster highlighting**
...
- [ ] **1.4 (Design polish) Apply DESIGN.md direction to the scoring panel**
...
- [ ] **2.1 Validate metrics against a reference name set**
...
- [ ] **2.2 Metric breakdown transparency**
...
- [ ] **2.4 (Design polish) Empty, loading, and edge-case states designed**
...
- [ ] **3.4 (Design polish) Responsive and accessibility pass**
